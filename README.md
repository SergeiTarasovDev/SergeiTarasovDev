...
<h3 align="center">Учился на программиста в ВУЗе, 13 лет программировал на разных языках. Уже 2+ года изучаю Java + Spring, прошел курсы в Иннополисе и SkyPro, стек на месте стажировки: Java Core, Spring Framework, Hibernate, Maven, PostgreSQL, Liquibase, Junit, Mockito, Postman, Swagger</h3>
<hr>
